...
--     animations = {
--       {
--         filename = "__Spaghetorio__/graphics/krastorio/entities/explosions/impulse-rifle-beam.png",
--         priority = "extra-high",
--         draw_as_glow = true,
--         width = 62,
--         height = 1,
...
--     animations = {
--       {
--         filename = "__Spaghetorio__/graphics/krastorio/entities/explosions/matter-shockwave-1.png",
--         priority = "high",
--         flags = { "smoke" },
--         line_length = 8,
--         width = 66,
...
--         hr_version = {
--           filename = "__Spaghetorio__/graphics/krastorio/entities/explosions/hr-matter-shockwave-1.png",
--           priority = "high",
--           flags = { "smoke" },
--           line_length = 8,
--           width = 132,
...
--       },
--       {
--         filename = "__Spaghetorio__/graphics/krastorio/entities/explosions/matter-shockwave-2.png",
--         priority = "high",
--         flags = { "smoke" },
--         line_length = 8,
--         width = 56,
...
--         shift = util.by_pixel(-1, 0),
--         hr_version = {
--           filename = "__Spaghetorio__/graphics/krastorio/entities/explosions/hr-matter-shockwave-2.png",
--           priority = "high",
--           flags = { "smoke" },
--           line_length = 8,
--           width = 110,
...
--         filename = "__Spaghetorio__/graphics/krastorio/entities/explosions/smoke.png",
--         flags = { "smoke" },
--       },
--     },
--   },
...
--     animations = {
--       {
--         filename = "__Spaghetorio__/graphics/krastorio/entities/explosions/beacon-explosion.png",
...
--     animations = {
--       {
--         filename = "__Spaghetorio__/graphics/krastorio/entities/explosions/rail-matter-explosion.png",
--         animation_speed = 0.5,
--         width = 600,
--         height = 800,
--         line_length = 6,
...
--     animations = {
--       {
--         filename = "__Spaghetorio__/graphics/krastorio/entities/explosions/laser_gunshot.png",
--         priority = "extra-high",
--         draw_as_glow = true,
--         width = 51,
--         height = 57,
...
--     subgroup = "explosions",
--     animations = {
--       filename = "__Spaghetorio__/graphics/krastorio/entities/explosions/laser-explosion.png",
--       flags = { "compressed" },
--       width = 300,
--       height = 300,
--       frame_count = 47,
