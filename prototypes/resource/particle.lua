...
data:extend({
  particle("sp-bauxite-particle", {r=1.0, g=0.5, b=0.5, a=1.0}),
  particle("sp-barite-particle", {r=1.0, g=1.0, b=0.8, a=1.0}),
  particle("sp-kernite-particle", {r=1.0, g=0.5, b=0.5, a=1.0}),
  particle("sp-chromite-particle", {r=0.5, g=0.5, b=1.0, a=1.0}),
  particle("sp-cobaltite-particle", {r=0.5, g=1, b=0.6, a=1.0}),
  particle("sp-titanium-ore-particle", {r=0.6, g=0.45, b=0.45, a=1.0}),
  particle("sp-magnesite-particle", {r=0.75, g=0.75, b=0.75, a=1.0}),
  particle("sp-pyrolusite-particle", {r=1.0, g=0.5, b=0.5, a=1.0}),
  particle("sp-cinnabar-particle", {r=0.35, g=0.15, b=0, a=1.0}),
  particle("sp-molybdate-particle", {r=1.0, g=0.5, b=0.5, a=1.0}),
  particle("sp-garnierite-particle", {r=0.8, g=0.1, b=0.1, a=1.0}),
  particle("sp-sylvite-particle", {r=0.3, g=0.9, b=0.61, a=1.0}),
  particle("sp-stibnite-particle", {r=0.5, g=1, b=0.6, a=1.0}),
  particle("sp-tinstone-particle", {r=0.1, g=0.9, b=0.7, a=1.0}),
  particle("sp-vanadinite-particle", {r=1.0, g=0.3, b=0.3, a=1.0}),
