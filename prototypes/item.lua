data:extend({
  ...
  ------------------------------------------------------------------------------
  {
    ...
    icon = "__Spaghenutti__/graphics/dummy/dummy-item-protactinium.png",
    icon_size = 128,
    scale = 0.5,
    subgroup = "useless",
    order = "[protactinium]",
  ...
  },
  {
    ...
    icon = "__Spaghenutti__/graphics/dummy/dummy-item-diet-water.png",
    icon_size = 128,
    scale = 0.5,
    subgroup = "useless",
    order = "[diet-water]",
  ...
  },
  {
    ...
    icon = "__Spaghenutti__/graphics/dummy/dummy-item-solar-powered-flash-light.png",
    icon_size = 128,
    scale = 0.5,
    subgroup = "useless",
  ...
  },
  {
    ...
    icon = "__Spaghenutti__/graphics/dummy/dummy-item-AC-Fan.png",
    icon_size = 128,
    scale = 0.5,
    subgroup = "useless",
    order = "[AC-Fan]",
