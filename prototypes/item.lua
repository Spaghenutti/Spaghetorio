...
data:extend({
  ...
  -- {
  --   type = "item",
  --   name = "sp-kr-fusion-reactor",
  --   icon = "__Spaghetorio__/graphics/krastorio/icons/entities/fusion-reactor.png",
  --   icon_size = 64,
  --   icon_mipmaps = 4,
  --   subgroup = "energy",
  --   order = "f[nuclear-energy]-b2[fusion-reactor]",
  --   place_result = "sp-kr-fusion-reactor",
  --   stack_size = 1,
  -- },
  -- {
  --   type = "item",
  --   name = "sp-kr-advanced-steam-turbine",
  --   icon = "__Spaghetorio__/graphics/krastorio/icons/entities/advanced-steam-turbine.png",
  --   icon_size = 64,
  --   icon_mipmaps = 4,
  --   subgroup = "energy",
  --   order = "f[nuclear-energy]-e2[advanced-steam-turbine]",
  --   place_result = "sp-kr-advanced-steam-turbine",
  --   stack_size = 25,
  -- },
  -- {
  --   type = "item",
