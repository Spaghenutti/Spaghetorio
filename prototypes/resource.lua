...
data:extend({
  ...
  },
  {
    ...
    minable = {
      hardness = 1,
      mining_particle = "rare-earths-particle",
      mining_time = 1,
      result = "rare-earths"
      },
    collision_box = {{ -0.1, -0.1}, {0.1, 0.1}},
    ...
    stages = {
      sheet = {
        filename = "__Spaghenutti__/graphics/ressource/rare-earths-patches.png",
        priority = "extra-high",
        size = 64,
        frame_count = 8,
        variation_count = 8,
        hr_version = {
          filename = "__Spaghenutti__/graphics/ressource/hr-rare-earths-patches.png",
          priority = "extra-high",
          size = 128,
          frame_count = 8,
          variation_count = 8,
