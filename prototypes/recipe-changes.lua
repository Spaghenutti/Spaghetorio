...
util.change_recipe_ingredients("logistic-robot",
  {{"flying-robot-frame", 1}, {"motor", 1}, {"battery", 4}, {"sp-titanium-plate", 2}},
  {{"flying-robot-frame", 1}, {"motor", 2}, {"battery", 6}, {"sp-titanium-plate", 4}},
  4,
  6)
...
util.change_recipe_ingredients("belt-immunity-equipment",
  {{"processing-unit", 2}, {"sp-stainless-steel-gear-wheel", 20}, {"electric-engine-unit", 2}, {"sp-bolts", 12}, {"sp-titanium-frame", 3}, {"sp-composites", 2}, {"sp-ball-bearing", 6}, {"sp-rubber", 2}},
  {{"processing-unit", 4}, {"sp-stainless-steel-gear-wheel", 30}, {"electric-engine-unit", 4}, {"sp-bolts", 20}, {"sp-titanium-frame", 5}, {"sp-composites", 5}, {"sp-ball-bearing", 10}, {"sp-rubber", 4}},
  20,
  30)
...
util.change_recipe_ingredients("solar-panel-equipment",
  {{"solar-panel", 1}, {"sp-bolts", 10}, {"advanced-circuit", 2}, {"sp-aluminum-frame", 2}, {"sp-insulated-wire", 4}},
  {{"solar-panel", 1}, {"sp-bolts", 12}, {"advanced-circuit", 5}, {"sp-aluminum-frame", 5}, {"sp-insulated-wire", 8}},
  10,
  15)
