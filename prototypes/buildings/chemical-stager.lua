...
local graphics_set = {
  animation = {
    layers = {
      {
        filename = "__Spaghetorio__/graphics/buildings/chemical-stager/chemical-stager-animation-1.png",
        priority = "high",
        width = 1600 / 8,
        height = 1600 / 8,
      ...
      {
        priority = "high",
        filename = "__Spaghetorio__/graphics/buildings/chemical-stager/chemical-stager-shadow.png",
        width = 400,
        height = 300,
        shift = graphics_shift,
        scale = graphics_scale,
  ...
  working_visualisations = {
    {
      ...
      animation = {
        priority = "high",
        filename = "__Spaghetorio__/graphics/buildings/chemical-stager/chemical-stager-emission-1.png",
        width = 1600 / 8,
        height = 1600 / 8,
        shift = graphics_shift,
        scale = graphics_scale,
...
data:extend({
 {
    ...
    crafting_categories = {"chemistry", "chemical-staging"},
    crafting_speed = 2,
    energy_source =
    {
      type = "electric",
