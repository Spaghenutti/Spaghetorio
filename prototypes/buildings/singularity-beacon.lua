...
data:extend({
  {
    ...
    base_picture = {
      ...
      hr_version = {
        filename = "__Spaghetorio__/graphics/krastorio/entities/singularity-beacon/hr-singularity-beacon.png",
        width = 360,
        height = 360,
        shift = util.by_pixel(0, -5),
        scale = 0.25,
      ...
      layers = {
        {
          ...
          animation_speed = 0.5,
          hr_version = {
            filename = "__Spaghetorio__/graphics/krastorio/entities/singularity-beacon/hr-singularity-beacon-w-light.png",
            width = 190,
            height = 214,
            frame_count = 10,
            line_length = 5,
        ...
        {
          filename = "__Spaghetorio__/graphics/krastorio/entities/singularity-beacon/singularity-beacon-w.png",
          width = 48,
          height = 54,
          frame_count = 10,
          line_length = 5,
          ...
          animation_speed = 0.5,
          hr_version = {
            filename = "__Spaghetorio__/graphics/krastorio/entities/singularity-beacon/hr-singularity-beacon-w.png",
            width = 190,
            height = 214,
            frame_count = 10,
            line_length = 5,
    ...
    animation_shadow = {
      filename = "__Spaghetorio__/graphics/krastorio/entities/singularity-beacon/singularity-beacon-ws.png",
      width = 10,
      height = 10,
      frame_count = 10,
      line_length = 5,
