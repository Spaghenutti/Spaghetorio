...
local graphics_set = {
  animation = {
    layers = {
      {
        filename = "__SpaghetorioGraphics1__/graphics/buildings/fusion-reactor/fusion-reactor-hr-animation-1.png",
        priority = "high",
        width = 3200 / 8,
        height = 3200 / 8,
      ...
      {
        priority = "high",
        filename = "__SpaghetorioGraphics1__/graphics/buildings/fusion-reactor/fusion-reactor-hr-shadow.png",
        width = 700,
        height = 600,
        shift = graphics_shift,
        scale = graphics_scale,
  ...
  working_visualisations = {
    {
      ...
      animation = {
        priority = "high",
        filename = "__SpaghetorioGraphics1__/graphics/buildings/fusion-reactor/fusion-reactor-hr-emission-1.png",
        width = 3200 / 8,
        height = 3200 / 8,
        shift = graphics_shift,
        scale = graphics_scale,
