...
function quantumkpipepictures()
  return {
    north = {
      ...
      hr_version = {
        filename = "__Spaghetorio__/graphics/krastorio/entities/quantum-computer/hr-quantum-computer-k-pipe-N.png",
        priority = "extra-high",
        width = 78, --71
        height = 71, -- 38
        shift = util.by_pixel(4.25, 23),
    ...
    east = {
      ...
      hr_version = {
        filename = "__Spaghetorio__/graphics/krastorio/entities/quantum-computer/hr-quantum-computer-k-pipe-E.png",
        priority = "extra-high",
        width = 42,
        height = 76,
    ...
    south = {
      ...
      hr_version = {
        filename = "__Spaghetorio__/graphics/krastorio/entities/quantum-computer/hr-quantum-computer-k-pipe-S.png",
        priority = "extra-high",
        width = 88,
        height = 61,
    ...
    west = {
      ...
      hr_version = {
        filename = "__Spaghetorio__/graphics/krastorio/entities/quantum-computer/hr-quantum-computer-k-pipe-W.png",
        priority = "extra-high",
        width = 39,
        height = 73,
    ...
    fluid_boxes = {
      {
        ...
        base_area = 10,
        base_level = -1,
        pipe_connections = { {flow_direction="input", direction = defines.direction.south, position = {-0.5, -3.5}} },
      ...
      },
      {
        ...
        base_area = 10,
        base_level = 1,
        pipe_connections = { {flow_direction="output", direction = defines.direction.south, position = {0.5, 3.5}} },
        secondary_draw_orders = { north = -1 },
      },
      ...
      layers = {
        {
          ...
          hr_version = {
            filename = "__Spaghetorio__/graphics/krastorio/entities/quantum-computer/hr-quantum-computer.png",
            priority = "high",
            width = 400,
            height = 420,
            shift = { 0, -0.2 },
        ...
        },
        {
          ...
          animation_speed = 0.25,
          hr_version = {
            filename = "__Spaghetorio__/graphics/krastorio/entities/quantum-computer/hr-quantum-computer-sh.png",
            priority = "medium",
            width = 402,
            height = 362,
            shift = { 0.19, 0.315 },
    ...
    working_visualisations = {
      {
        ...
        animation = {
          ...
          animation_speed = 0.25,
          hr_version = {
            filename = "__Spaghetorio__/graphics/krastorio/entities/quantum-computer/hr-quantum-computer-light.png",
            priority = "extra-high",
            width = 400,
            height = 420,
            shift = { 0, -0.2 },
      ...
      },
      {
        ...
        animation = {
          ...
          animation_speed = 0.25,
          hr_version = {
            filename = "__Spaghetorio__/graphics/krastorio/entities/quantum-computer/hr-quantum-computer-glow.png",
            priority = "extra-high",
            width = 400,
            height = 420,
            shift = { 0, -0.2 },
