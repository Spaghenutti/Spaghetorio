      ...
      layers = {
        {
          ...
          shift = { 0, -1.2 },
          hr_version = {
            filename = "__Spaghetorio__/graphics/krastorio/entities/wind-turbine/hr-wind-turbine.png",
            priority = "medium",
            width = 196,
            height = 286,
            scale = 0.5,
        ...
        },
        {
          ...
          shift = { 1.15, 0.05 },
          hr_version = {
            filename = "__Spaghetorio__/graphics/krastorio/entities/wind-turbine/hr-wind-turbine-shadow.png",
            priority = "medium",
            width = 242,
            height = 100,
            scale = 0.65,
