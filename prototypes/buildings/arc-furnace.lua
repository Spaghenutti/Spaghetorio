...
local graphics_set = {
  animation = {
    layers = {
      {
        filename = "__Spaghetorio__/graphics/buildings/arc-furnace/arc-furnace-animation-1.png",
        priority = "high",
        width = 1280 / 8,
        height = 1120 / 7,
      ...
      {
        priority = "high",
        filename = "__Spaghetorio__/graphics/buildings/arc-furnace/arc-furnace-shadow.png",
        width = 300,
        height = 200,
        shift = graphics_shift,
        frame_count = 1,
  ...
  working_visualisations = {
    {
      ...
      animation = {
        priority = "high",
        filename = "__Spaghetorio__/graphics/buildings/arc-furnace/arc-furnace-emission-1.png",
        width = 1280 / 8,
        height = 1120 / 7,
        shift = graphics_shift,
        frame_count = graphics_frame_count,
