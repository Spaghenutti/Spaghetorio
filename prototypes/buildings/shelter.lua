  ...
  layers = {
    {
      ...
      animation_speed = 0.5,
      hr_version = {
        filename = "__Spaghetorio__/graphics/krastorio/entities/shelter/hr-shelter-light.png",
        priority = "high",
        width = 512,
        height = 512,
        scale = 0.45,
    ...
    },
    {
      ...
      animation_speed = 0.5,
      hr_version = {
        filename = "__Spaghetorio__/graphics/krastorio/entities/shelter/hr-shelter.png",
        priority = "high",
        width = 512,
        height = 512,
        scale = 0.45,
    ...
    },
    {
      ...
      draw_as_shadow = true,
      hr_version = {
        filename = "__Spaghetorio__/graphics/krastorio/entities/shelter/hr-shelter-shadow.png",
        priority = "high",
        width = 512,
        height = 512,
        scale = 0.45,
