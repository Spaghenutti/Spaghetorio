...
table.insert(data.raw.technology["jetpack-3"].prerequisites, "production-science-pack")
table.insert(data.raw.technology["jetpack-3"].prerequisites, "sp-material-science-pack-2")
