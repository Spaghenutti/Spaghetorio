...
table.insert(data.raw.technology["bulk-inserter"].prerequisites, "advanced-electronics")
...
table.insert(data.raw.technology["advanced-material-processing"].unit.ingredients, {type = "item", name = "sp-material-science-pack-1", amount = 1})
...
data.raw.technology["electric-energy-distribution-2"].unit.ingredients = {
  {type = "item", name = "sp-automation-science-pack-2", amount = 2},
  {type = "item", name = "sp-logistic-science-pack-2", amount = 2},
  {type = "item", name = "sp-material-science-pack-2", amount = 1},
  {type = "item", name = "sp-geological-science-pack-2", amount = 1},
  {type = "item", name = "sp-electronic-science-pack-2", amount = 1}
}
