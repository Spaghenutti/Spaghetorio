...
table.insert(data.raw.recipe["sp-automation-science-pack-2"].ingredients, {type = "item", name = "engine-unit", amount = 2})
...
table.insert(data.raw.recipe["sp-chemical-science-pack-2"].ingredients, {type = "item", name = "blank-tech-card", amount = 5})
table.insert(data.raw.recipe["sp-electronic-science-pack-2"].ingredients, {type = "item", name = "blank-tech-card", amount = 5})
table.insert(data.raw.recipe["sp-geological-science-pack-2"].ingredients, {type = "item", name = "blank-tech-card", amount = 5})
table.insert(data.raw.recipe["sp-material-science-pack-2"].ingredients, {type = "item", name = "blank-tech-card", amount = 5})
...
table.insert(data.raw.recipe["sp-automation-science-pack-3"].ingredients, {type = "item", name = "blank-tech-card", amount = 5})
table.insert(data.raw.recipe["sp-logistic-science-pack-3"].ingredients, {type = "item", name = "blank-tech-card", amount = 5})
table.insert(data.raw.recipe["sp-military-science-pack-3"].ingredients, {type = "item", name = "blank-tech-card", amount = 5})
table.insert(data.raw.recipe["sp-military-science-pack-3"].ingredients, {type = "item", name = "biters-research-data", amount = 3})
table.insert(data.raw.recipe["sp-chemical-science-pack-3"].ingredients, {type = "item", name = "blank-tech-card", amount = 5})
table.insert(data.raw.recipe["sp-electronic-science-pack-3"].ingredients, {type = "item", name = "blank-tech-card", amount = 5})
table.insert(data.raw.recipe["sp-geological-science-pack-3"].ingredients, {type = "item", name = "blank-tech-card", amount = 5})
table.insert(data.raw.recipe["sp-material-science-pack-3"].ingredients, {type = "item", name = "blank-tech-card", amount = 5})
table.insert(data.raw.recipe["sp-astronomical-science-pack-3"].ingredients, {type = "item", name = "blank-tech-card", amount = 5})
table.insert(data.raw.recipe["sp-computer-science-pack-3"].ingredients, {type = "item", name = "blank-tech-card", amount = 5})
table.insert(data.raw.recipe["sp-production-science-pack-3"].ingredients, {type = "item", name = "blank-tech-card", amount = 5})
table.insert(data.raw.recipe["sp-utility-science-pack-3"].ingredients, {type = "item", name = "blank-tech-card", amount = 5})
